...
class TestFlinks < Minitest::Test
  ...
  def test_client_uses_current_configuration
    ...
    assert_equal 'https://configured.example/v3/configured-customer/BankingServices/GenerateAuthorizeToken',
  ...
  def test_get_accounts_detail_async_returns_pending_resource_for_202
    ...
    assert_equal '/v3/43387ca6-0391-4c82-857d-70d95f087ecb/BankingServices/GetAccountsDetailAsync/077785a3-fd0f-42f7-9251-ee2ff7f3b4ff',
                 captured_path
  end
  ...
  def test_authorize_cached_session_success
    ...
    assert_equal '/v3/43387ca6-0391-4c82-857d-70d95f087ecb/BankingServices/GenerateAuthorizeToken',
  ...
  def test_get_accounts_detail_raises_session_nonexistent_error
    ...
    Faraday.stub :new, connection do
      ...
      assert_equal 'RequestId 1df20baf-65d5-40ee-9be0-8058c13042e2 is invalid or session has ended',
